...
if mode == 0:
    ...
    if kmeanspp == 0:
        ...
        dir_name = f"spectral/ratio/image1++/k={k_num}"
    start = time.time()
    labels1, loss1 = spectral_ratio_cut(W=kernel1, epoch=30, k=k_num, image_size=(100, 100), dir_name=dir_name, kmeanspp=kmeanspp)
    end = time.time()
    print("Time:")
    print(end - start)
    make_gif_from_frames(dir_name, f"{dir_name}.gif", duration=500)
    ...
    if kmeanspp == 0:
        ...
        dir_name = f"spectral/ratio/image2++/k={k_num}"
    start = time.time()
    labels2, loss2 = spectral_ratio_cut(W=kernel2, epoch=30, k=k_num, image_size=(100, 100), dir_name=dir_name, kmeanspp=kmeanspp)
    end = time.time()
    print("Time:")
    print(end - start)
    make_gif_from_frames(dir_name, f"{dir_name}.gif", duration=500)
    ...
    if kmeanspp == 0:
        ...
        dir_name = f"spectral/normalized/image1++/k={k_num}"
    start = time.time()
    labels1, loss1 = spectral_normalized_cut(W=kernel1, epoch=30, k=k_num, image_size=(100, 100), dir_name=dir_name, kmeanspp=kmeanspp)
    end = time.time()
    print("Time:")
    print(end - start)
    make_gif_from_frames(dir_name, f"{dir_name}.gif", duration=500)
    ...
    if kmeanspp == 0:
        ...
        dir_name = f"spectral/normalized/image2++/k={k_num}"
    start = time.time()
    labels2, loss2 = spectral_normalized_cut(W=kernel2, epoch=30, k=k_num, image_size=(100, 100), dir_name=dir_name, kmeanspp=kmeanspp)
    end = time.time()
    print("Time:")
    print(end - start)
    make_gif_from_frames(dir_name, f"{dir_name}.gif", duration=500)
